...
fitting_task = 'nosurv+urb_p+bestpairs+s1l6'  # fitting task name
################################################################################
...
greedy_base = []
greedy_base.append(['tp_24hmean_pop_weighted_log(2)', 'tp_24hmean_pop_weighted_log(5)'])
greedy_base.append(['tp_24hmean_pop_weighted_log(1)', 'tp_24hmean_pop_weighted_log(6)'])
greedy_base.append(['tp_24hmean_pop_weighted_log(1)', 't2m_max_pop_weighted(4)'])
greedy_base.append(['tp_24hmean_pop_weighted_log(5)', 'rh_mean_pop_weighted(1)'])
