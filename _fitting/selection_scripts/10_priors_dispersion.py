...
if __name__ == "__main__":
    ...
    for disp_sigma_val in [0.1, 0.25, 0.5, 1.0, 2.0, 2.5, 5.0]:
        settings = {'stat_names': [],
                    'disp_sigma': disp_sigma_val,
                    'intercept_sigma': 1.0,
                    'intercept_mu': -10,
                    'degree': 3, 
                    'num_knots': 5,
    ...
    ## RESULTS - disp_sigma 1.0
    # as with intercept prior, all values fit the same, same mean, hdi_%3 and hdi_%97, and same posterior
    # so likelihood is dominating. Fitted value is very tight on 0.4, will keep prior sd at 1.0 as
    # this is weak and covers the fitted value well.