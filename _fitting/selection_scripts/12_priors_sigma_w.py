...
if __name__ == "__main__":
    ...
    for sigma_w_sigma_val in [0.1, 0.25, 0.5, 0.75, 1.0, 1.5, 2.0, 2.5, 5.0]:
        for stat_name in ['rh_mean_pop_weighted(0)', 't2m_mean_pop_weighted(0)',
            ...
            settings = {'stat_names': [stat_name],
                        ...
                        'num_knots': 5,
                        'beta_u_sigma': 1.0,
                        'sigma_w_sigma': sigma_w_sigma_val,
