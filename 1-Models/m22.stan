...
model {
    ...
    ni_y ~ neg_binomial_2_log(beta_0 + ni_log_pop + ni_log_surv + beta_urb*ni_urb + beta_d*ni_urb_dens_X_u, disp);
    i_y ~ neg_binomial_2_log(beta_0 + i_log_pop + i_log_surv + beta_urb*i_urb + beta_d*i_urb_dens_X_u, disp);
}